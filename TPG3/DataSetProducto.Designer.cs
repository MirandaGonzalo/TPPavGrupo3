...
namespace ProbandoMigrar {
    ...
    public partial class DataSetProducto : global::System.Data.DataSet {
        ...
        public partial class ProductoDataTable : global::System.Data.TypedTableBase<ProductoRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ProductoRow AddProductoRow(string nombre, string descripcion, int tipoProducto, decimal precio) {
        ...
        public partial class ProductoRow : global::System.Data.DataRow {
            ...
            public int tipoProducto {
                get {
                    try {
                        return ((int)(this[this.tableProducto.tipoProductoColumn]));
                    }
...
namespace ProbandoMigrar.DataSetProductoTableAdapters {
    ...
    public partial class ProductoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Producto] WHERE (([idProducto] = @Original_idProducto) AND ([nombre] = @Original_nombre) AND ([descripcion] = @Original_descripcion) AND ((@IsNull_tipoProducto = 1 AND [tipoProducto] IS NULL) OR ([tipoProducto] = @Original_tipoProducto)) AND ([precio] = @Original_precio))";
            ...
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_tipoProducto", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "tipoProducto", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Producto] ([nombre], [descripcion], [tipoProducto], [precio]) " +
                "VALUES (@nombre, @descripcion, @tipoProducto, @precio);\r\nSELECT idProducto, nomb" +
                "re, descripcion, tipoProducto, precio FROM Producto WHERE (idProducto = SCOPE_ID" +
                "ENTITY())";
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@tipoProducto", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "tipoProducto", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Producto] SET [nombre] = @nombre, [descripcion] = @descripcion, [tipoProducto] = @tipoProducto, [precio] = @precio WHERE (([idProducto] = @Original_idProducto) AND ([nombre] = @Original_nombre) AND ([descripcion] = @Original_descripcion) AND ((@IsNull_tipoProducto = 1 AND [tipoProducto] IS NULL) OR ([tipoProducto] = @Original_tipoProducto)) AND ([precio] = @Original_precio));
SELECT idProducto, nombre, descripcion, tipoProducto, precio FROM Producto WHERE (idProducto = @idProducto)";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@tipoProducto", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "tipoProducto", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_tipoProducto", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "tipoProducto", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT idProducto, nombre, descripcion, tipoProducto, precio FROM dbo.Producto";
        ...
        public virtual int Delete(int Original_idProducto, string Original_nombre, string Original_descripcion, global::System.Nullable<int> Original_tipoProducto, decimal Original_precio) {
            ...
            if ((Original_tipoProducto.HasValue == true)) {
                this.Adapter.DeleteCommand.Parameters[3].Value = ((object)(0));
                this.Adapter.DeleteCommand.Parameters[4].Value = ((int)(Original_tipoProducto.Value));
            }
            else {
        ...
        public virtual int Insert(string nombre, string descripcion, global::System.Nullable<int> tipoProducto, decimal precio) {
            if ((nombre == null)) {
            ...
            if ((tipoProducto.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[2].Value = ((int)(tipoProducto.Value));
            }
            else {
        ...
        public virtual int Update(string nombre, string descripcion, global::System.Nullable<int> tipoProducto, decimal precio, int Original_idProducto, string Original_nombre, string Original_descripcion, global::System.Nullable<int> Original_tipoProducto, decimal Original_precio, int idProducto) {
            if ((nombre == null)) {
                throw new global::System.ArgumentNullException("nombre");
            }
            else {
            ...
            if ((tipoProducto.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[2].Value = ((int)(tipoProducto.Value));
            }
            else {
            ...
            if ((Original_tipoProducto.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[8].Value = ((int)(Original_tipoProducto.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string nombre, string descripcion, global::System.Nullable<int> tipoProducto, decimal precio, int Original_idProducto, string Original_nombre, string Original_descripcion, global::System.Nullable<int> Original_tipoProducto, decimal Original_precio) {
            return this.Update(nombre, descripcion, tipoProducto, precio, Original_idProducto, Original_nombre, Original_descripcion, Original_tipoProducto, Original_precio, Original_idProducto);
        }
    }
